...
ALTER TABLE reservation
    ADD COLUMN reservation_at TIMESTAMP;

UPDATE reservation
SET reservation_at = reservation_date + reservation_time;

ALTER TABLE reservation
    ALTER COLUMN reservation_at SET NOT NULL;
...
UPDATE reservation
SET contrast_used = FALSE
WHERE contrast_used IS NULL;

ALTER TABLE reservation
    ALTER COLUMN contrast_used SET DEFAULT FALSE;

ALTER TABLE reservation
    ALTER COLUMN contrast_used SET NOT NULL;
